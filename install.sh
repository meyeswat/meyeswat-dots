...
yay -S --asexplicit minecraft-launcher aseprite wlogout blockbench vesktop python-pywal16 pywal16 python-pywalfox pywal-discord-git qdirstat vencord wallpypr prismlauncher ttf-iosevka-nerd ttf-iosevkaterm-nerd ttf-iosevkatermslab-nerd ttf-jetbrains-mono-nerd ttf-liberation-mono-nerd ttf-nerd-fonts-symbols ttf-nerd-fonts-symbols-common ttf-nerd-fonts-symbols-mono lostfiles vala pacutils sassc dssd rust trimage waterfox-bin gdm-settings
